...
public class PrestamoDAO {
    ...
    private static final String INSERT_QUERY = "INSERT INTO Prestamo (fechaInicio, fechaFin, estado, isbnLibro, numeroSocio) VALUES (?, ?, ?, ?, ?)";
    private static final String SELECT_ALL_QUERY = "SELECT * FROM Prestamo";
    private static final String SELECT_BY_ISBN_QUERY = "SELECT * FROM Prestamo WHERE fechaInicio = ?";
